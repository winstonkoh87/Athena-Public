...
**Retrieval quality (65-query gold set, 25 Aug 2026)**: MRR@5 **0.769** · Hit@5 **0.892** · Coverage **0.639** — measured end-to-end on the reference deployment with reranking on.
